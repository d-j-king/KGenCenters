...
This module lives within a larger project on optimal transport for factor discovery, which also includes [Kai M. Hung's variability-reduction work](https://github.com/KataTech/OTFactorDiscovery).

---

## Acknowledgments

Thanks to **Andrew Lipnick**, **Nina Mortensen**, and **Ryan Du** for their support during the program.
